...
| `public/models/statue_angel.glb` | от владельца проекта — каменный ангел, памятник на казне; 3.31 → 0.26 МБ, рост сведён к четырём метрам, `scripts/prepare-town.ts` | CC, со слов владельца (вид не указан) |
