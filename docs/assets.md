...
| `public/textures/bar_health.webp` · `bar_stamina.webp` · `bar_mana.webp` | от владельца проекта — три клинка, полосы жизни, стамины и маны; растянуты до полных `scripts/prepare-bars.ts`, по 3–4 КБ | уточнить |
...
npx tsx scripts/prepare-bars.ts       # три полосы-клинка: 83 КБ png → 10 КБ webp
