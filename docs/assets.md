...
| `public/models/town_hall.glb` | от владельца проекта — ратуша, выгрузка FBX; 2.10 → 0.12 МБ, рост 11 м, `scripts/prepare-town.ts` | CC, со слов владельца (вид не указан) |
