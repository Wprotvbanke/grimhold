...
export const MOBS: Record<MobId, MobProfile> = {
  ...
  wight: {
    ...
    loot: [
      ...
      // Свитки трёх ремёсел сразу: выпавший чужой прочесть нельзя, и это
      // не досада, а повод торговать. Временно, до подземелий вехи 6.
      { itemId: 'scroll_iron_sword', name: 'Свиток: железный меч', chance: 0.06, min: 1, max: 1 },
      { itemId: 'scroll_hunting_bow', name: 'Свиток: охотничий лук', chance: 0.06, min: 1, max: 1 },
      { itemId: 'scroll_health_potion', name: 'Свиток: зелье здоровья', chance: 0.06, min: 1, max: 1 },
    ],
  },
};
