...
export interface ItemDef {
  ...
  swing?: number;
  /**
   * Свои фазы удара — вместо множителя `swing`.
   *
   * Множитель тянет все фазы разом, а луку нужна другая раскладка: долгий
   * замах (натянуть) и короткий хвост после выстрела — стрела должна
