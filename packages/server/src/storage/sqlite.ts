...
export class SqliteStorage implements Storage {
   ...
   *
   * Пишется немедленно, как всякая операция с ценностями: вещи и прокачка
   * лежат в той же строке, и «удалю потом, пакетом» означало бы окно, в
   * котором персонаж уже удалён на экране, но ещё жив в базе.
   */
