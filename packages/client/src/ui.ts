...
export class Ui {
  ...
  private readonly stage = createPortrait(el<HTMLCanvasElement>('lobbyStage'), {
    ...
    shift: 0.12,
    /**
     * Человек и эльф крупнее дворфа в кадре.
     *
     * Их рост и так больше, а на заднике они всё равно смотрелись мельче:
     * дворф шире в плечах и занимает кадр плотнее. Владелец попросил
     * поднять этих двоих на треть — дворфа оставляем как есть.
     */
    zoom: { human: 1.3, elf: 1.3 },
  });
