 ...
 * Высота мешка в мире.
 *
 * Тридцать семь сантиметров — кисет, а не баул, но такой, чтобы его замечали
 * с ходу. Полметра было под дорожный саквояж, и мешочек в том же росте
 * выглядел мешком с мукой; тридцать оказалось скромно — на мостовой он терялся
 * среди камней.
 */
const BAG_HEIGHT = 0.37;
