 ...
 *
 * Не настоящий шаг, а **шаг на слух**. Была честная доля в 0.8 роста, но
 * ходьба в игре быстрая — пять метров в секунду, — и человек перебирал
 * ногами три с половиной раза в секунду: звучало суетой, а не походкой.
 * При 1.4 роста выходит два шага в секунду на ходу и чуть больше трёх
 * на бегу — темп, который ухо принимает за спокойный шаг.
 */
const STRIDE_PER_HEIGHT = 1.4;
