...
export const SOUNDS = {
   ...
   *
   * Три отрывка ритуального пения (OwlishMedia, CC0) по 1.7 с — под самый
   * долгий замах свитка. Тихо и через срез верхов: заговор бормочут себе
   * под нос, а не поют на площадь. Чужой каст пока звучит взмахом: спелл
   * чужого в снапшоте не ездит, и отличить каст от удара клиенту нечем.
   */
  castWhisper: {
