...
export const SOUNDS = {
  ...
  /**
   * Вещь выброшена из рюкзака — глухой мягкий удар о землю.
   *
   * Тихо намеренно: выбрасывают часто и помногу, разбирая добычу, и звук
   * этот — подтверждение, а не событие. Верхи срезаны, чтобы падение
   * не щёлкало над ухом.
   */
  dropItem: {
    files: five('impactSoft_heavy'),
    volume: 0.22,
    positional: false,
    detune: 0.08,
    lowpass: 2200,
